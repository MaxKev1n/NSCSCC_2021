...
HD_PWD='E:/NSCSCC/NSCSCC_2021/project_1/project_1.runs/divider_u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divider_u.tcl
