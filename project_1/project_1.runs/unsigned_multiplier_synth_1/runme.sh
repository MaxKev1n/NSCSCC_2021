...
HD_PWD='E:/NSCSCC/NSCSCC_2021/project_1/project_1.runs/unsigned_multiplier_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unsigned_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unsigned_multiplier.tcl
